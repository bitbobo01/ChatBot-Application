...
from CategorizeDocument import get_category_tree, add_category, save_summary,update_category_parent_and_split
import sys
import os
import json
import re
...
def process_document(content):
    ...
    chunks = split_text(content,15000)  # Chia nhỏ tài liệu nếu quá dài
